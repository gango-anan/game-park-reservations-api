...
puts "Created #{User.count} user: #{first_user.username}"
...
activity_one = Activity.create!(
  ...
  image_url: 'https://source.unsplash.com/800x400/?gorilla',
  details: "
...
activity_two = Activity.create!(
  ...
  image_url: 'https://source.unsplash.com/800x400/?gamedrives',
  details: "
...
activity_three = Activity.create!(
  title: 'Birding',
  park: "Queen Elizabeth #{NP}",
  image_url: 'https://source.unsplash.com/800x400/?birding',
  details: "
...
activity_four = Activity.create!(
  ...
  park: "Bwindi Impenetrable #{NP}",
  image_url: 'https://source.unsplash.com/800x400/?forest',
  details: "
...
activity_five = Activity.create!(
  ...
  image_url: 'https://source.unsplash.com/800x400/?hiking',
  details: "
...
activity_six = Activity.create!(
  title: 'Sport Hunting',
  park: "Kidepo #{NP}",
  image_url: 'https://source.unsplash.com/800x400/?hunting',
  details: "
...
activity_seven = Activity.create!(
  title: 'Sport Fishing',
  park: "Lake Mburo #{NP}",
  image_url: 'https://source.unsplash.com/800x400/?fishing',
  details: "
...
activity_eight = Activity.create!(
  ...
  park: "Kibale #{NP}",
  image_url: 'https://source.unsplash.com/800x400/?chimpanzee',
  details: "
...
activity_nine = Activity.create!(
  ...
  park: "Mount Elgon #{NP}",
  image_url: 'https://source.unsplash.com/800x400/?mountainbiking',
  details: "
